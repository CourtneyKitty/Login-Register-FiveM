$(document).ready(function(){
  ...
  function openContainer() {
    $(".nypd").css("display", "block");
    $("#cursor").css("display", "block");
  }
  function closeContainer() {
    $(".nypd").css("display", "none");
  ...
  $(".btnQuestion").click(function(){
      $.post('http://policemdt/question', JSON.stringify({}));
  });
  $(".btnClose").click(function(){
      $.post('http://policemdt/close', JSON.stringify({}));
  });
  $(".btnKick").click(function(){
      $.post('http://policemdt/kick', JSON.stringify({}));
  });
